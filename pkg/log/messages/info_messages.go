...
const CSPFK027I string = "CSPFK027I Processing file as YAML config: %s"
const CSPFK028I string = "CSPFK028I Processing file as Kubernetes Downward API annotations: %s"
const CSPFK029I string = "CSPFK029I Secrets will be pushed to Kubernetes Secrets"
const CSPFK030I string = "CSPFK030I Secrets will be pushed to file: %s"
const CSPFK031I string = "CSPFK031I JWT SVID fetched successfully!"
const CSPFK032I string = "CSPFK032I Collecting template for group: %s"
const CSPFK033I string = "CSPFK033I Reading template for group %s from file: %s"
