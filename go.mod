...
replace github.com/cyberark/conjur-api-go => github.com/cyberark/conjur-api-go v0.12.10

// Develop locally
replace github.com/cyberark/conjur-authn-k8s-client => ./conjur-authn-k8s-client
